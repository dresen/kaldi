...
# Write wav.scp, utt2spk and text.unnormalised for train and test with
# Use sph2pipe because the wav files are actually sph files
echo "Creating wav.scp, utt2spk and text.unnormalised for train, test" 
